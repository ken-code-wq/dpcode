// This file mostly exists because we want dev mode to say "Tyde (Dev)" instead of "electron"
...
const APP_BUNDLE_ID = isDevelopment ? "com.t3tools.tyde.dev" : "com.t3tools.tyde";
